...
class StoreAppointmentRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        return [
            ...
            'service_items_ids.array'   => 'يجب أن تكون الأصناف المرتبطة بالخدمة عبارة عن مصفوفة.',
            'service_items_ids.*.exists' => 'أحد الأصناف المحددة غير موجود في المخزن.',
            'serviceitemsids.array'     => 'يجب أن تكون الأصناف المرتبطة بالخدمة عبارة عن مصفوفة.',
            'serviceitemsids.*.exists'   => 'أحد الأصناف المحددة غير موجود في المخزن.',
